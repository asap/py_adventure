...
def play_game(player, entities, game_map,
              message_log, game_state, con, panel, constants):
    fov_recompute = True
    ...
    while not libtcod.console_is_window_closed():
        ...
        render_all(
            con, panel, entities, player, game_map,
        ...
        for player_turn_result in player_turn_results:
            ...
            item_dropped = player_turn_result.get('dropped')
        ...
        if show_main_menu:
            ...
            if show_load_error_message and (new_game or
                ...
                (player, entities, game_map,
                 message_log, game_state) = get_game_variables(constants)
            ...
            play_game(player, entities, game_map,
                      message_log, game_state, con, panel, constants)
